...
@commands.has_role(1006725140933001246)
async def faq(ctx):
  embed = discord.Embed(title="**Announcement Pings**", description="Click on 📣 for announcement pings*(click again to remove)*", color=cfc)
  emb = discord.Embed(title="**Update Pings**", description="Click on 🛠 for update pings*(click again to remove)*", color=cfc)
