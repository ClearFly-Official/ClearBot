...
@weather.command()
@option("location", description="The location you want the weather information from.", autocomplete=get_cities)
async def weather(ctx, location):
  async def getweather():
    async with python_weather.Client(format=python_weather.METRIC) as client:
      ...
      embed=discord.Embed(title=f"Current weather in {location}:",description=f"{weather.current.temperature}", color=cfc)
      embed.add_field(name="Temperature:", value=f"{weather.current.temperature}")
